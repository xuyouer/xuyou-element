...
export const getTimeZoneSupported = DateUtils.getTimeZoneSupported
export const getTimeZone = DateUtils.getTimeZone
export const timeFormat = DateUtils.timeFormat